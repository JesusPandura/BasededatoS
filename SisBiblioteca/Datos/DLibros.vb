...
Public Class DLibros
    ...
    Public Function VerificarLibro(ByVal Llibro As LLibros) As DataTable
        Try
            ...
            With cmd.Parameters
                .AddWithValue("@codlibro", Llibro._ClaveLibro
                              )
    ...
    Public Function Agregarlibro(ByVal llibro As LLibros) As Boolean
        ...
        Try
            ...
            With cmd.Parameters
                ...
                .AddWithValue("@codautor", llibro._ClaveAutor)
    ...
    Public Function MostraPe() As DataTable
        Try
            Conectar()
            Dim cmd As New SqlCommand("BuscarEstadoo", con)
            cmd.CommandType = CommandType.StoredProcedure
            Dim tablalibros As New DataTable
    ...
    Public Function DetallesPe() As DataTable
        Try
            Conectar()
            Dim cmd As New SqlCommand("Detalles", con)
            cmd.CommandType = CommandType.StoredProcedure
            Dim tablalibros As New DataTable
