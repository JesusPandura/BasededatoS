Public Class FNPrestamo
    ...
    Public Function VerificarLector() As Boolean
        Try
            ...
            DatLector._ClaveLector = Convert.ToInt32(txtCodLector.Text)
    ...
    Public Function VerificarLibro() As Boolean
        Try
            Dim resultado As DataTable
            DatLibro._ClaveLibro = Convert.ToInt32(txtCodLibro.Text)
    ...
    Private Sub dtpFecDevolucion_ValueChanged(sender As Object, e As EventArgs) Handles dtpFecDevolucion.ValueChanged
    ...
    Private Sub dgvLibro_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvLibro.CellContentClick
